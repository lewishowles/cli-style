...
| `row-group`           | `rowGroup(options)`                   | Use `cli_style_render`               | `row_group(rows)`                  | Use `CliStyle.render`                  | Auto-aligned group of labelled value rows.                      |
| `bullet-list`         | `bulletList(items, options)`          | Use `cli_style_render`               | `bullet_list(items)`               | Use `CliStyle.render`                  | Wrapped flat or nested bullet items.                            |
...
| `table`               | `table(options)`                      | Use `cli_style_render`               | `table(columns, rows)`             | Use `CliStyle.render`                  | Tabular records with narrow-width fallback.                     |
